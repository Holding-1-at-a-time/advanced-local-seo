...
const CLUSTER_TOPICS: Record<string, Array<{ slug: string; title: string; description: string }>> = {
  ...
  "ceramic-coating": [
    ...
    },
    {
      ...
      title: "Ceramic Coating Cost Guide",
      description: "Understanding the investment of professional ceramic coating in San Antonio.",
    },
    {
      slug: "ceramic-coating-process",
      title: "Ceramic Coating Process",
      description: "Step-by-step guide to professional ceramic coating application and what to expect.",
    },
  ],
  "paint-correction": [
    {
